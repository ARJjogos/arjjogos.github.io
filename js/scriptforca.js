...
function palavraAl() {
  ...
  resposta = termos_fotografia[Math.floor(Math.random() * termos_fotografia.length)];
}

function botoes() {

 let buttonsHTML = 'ABCDEFGHIJKLMNOPQRSTUVWXYZÇÃ'.split('').map(letter =>
